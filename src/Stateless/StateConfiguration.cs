...
public partial class StateMachine<TState, TTrigger> {
    ...
    public partial class StateConfiguration {
        ...
        /// <param name="internalAction">The action performed by the internal transition</param>
        /// <returns></returns>
        public StateConfiguration InternalTransition<TArg0>(TriggerWithParameters<TTrigger, TArg0> trigger,
        ...
        /// <param name="guardDescription">A description of the guard condition</param>
        /// <returns></returns>
        public StateConfiguration InternalTransitionIf<TArg0>(TriggerWithParameters<TTrigger, TArg0> trigger,
        ...
        /// <param name="guardDescription">Guard description</param>
        /// <returns>The receiver.</returns>
        public StateConfiguration PermitIf<TArg0>(TriggerWithParameters<TTrigger, TArg0> trigger,
        ...
        /// <param name="guardDescription">Guard description</param>
        /// <returns>The receiver.</returns>
        public StateConfiguration PermitReentryIf<TArg0>(TriggerWithParameters<TTrigger, TArg0> trigger,
                                                         Func<TArg0?, bool> guard,
                                                         string? guardDescription = null) {
            if (trigger == null) throw new ArgumentNullException(nameof(trigger));
        ...
        /// </param>
        /// <returns>The receiver.</returns>
        public StateConfiguration IgnoreIf<TArg0>(TriggerWithParameters<TTrigger, TArg0> trigger,
                                                  Func<TArg0?, bool>                     guard,
                                                  string?                                guardDescription = null) {
            if (trigger == null) throw new ArgumentNullException(nameof(trigger));
        ...
        /// <param name="entryActionDescription">Action description.</param>
        /// <returns>The receiver.</returns>
        public StateConfiguration OnEntryFrom(TriggerWithParameters<TTrigger> trigger, Action<Transition> entryAction,
                                              string?                         entryActionDescription = null) {
            if (trigger     == null) throw new ArgumentNullException(nameof(trigger));
            if (entryAction == null) throw new ArgumentNullException(nameof(entryAction));
        ...
        /// <param name="entryActionDescription">Action description.</param>
        /// <returns>The receiver.</returns>
        public StateConfiguration OnEntryFrom<TArg0>(TriggerWithParameters<TTrigger, TArg0> trigger,
        ...
        /// <returns>The receiver.</returns>
        /// <typeparam name="TArg0">Type of the first trigger argument.</typeparam>
        public StateConfiguration PermitDynamic<TArg0>(TriggerWithParameters<TTrigger, TArg0> trigger,
        ...
        /// <returns>The receiver.</returns>
        /// <typeparam name="TArg0">Type of the first trigger argument.</typeparam>
        public StateConfiguration PermitDynamicIf<TArg0>(TriggerWithParameters<TTrigger, TArg0> trigger,
                                                         Func<TArg0?, TState> destinationStateSelector,
                                                         Func<bool> guard, string? guardDescription = null,
                                                         DynamicStateInfos? possibleDestinationStates = null) {
            if (trigger                  == null) throw new ArgumentNullException(nameof(trigger));
