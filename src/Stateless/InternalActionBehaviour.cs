...
public partial class StateMachine<TState, TTrigger> {
    internal abstract class InternalActionBehaviour {
        ...
        public class Sync : InternalActionBehaviour {
            ...
            public Sync(Action<Transition, object[]> action) => _action = action;
        ...
        public class Async : InternalActionBehaviour {
            ...
            public Async(Func<Transition, object[], Task> action) => _action = action;
            ...
            public override Task ExecuteAsync(Transition transition, object[] args) => _action(transition, args);
        }
    }
}