...
namespace Stateless.Tests
{
    ...
    public class StateRepresentationFixture
    {
        ...
        public void UponEntering_EnteringActionsExecuted()
        {
            ...
            stateRepresentation.AddEntryAction((t, a) => actualTransition = t, MethodDescription.Create(null, "entryActionDescription"));
        ...
        public void UponLeaving_LeavingActionsExecuted()
        {
            ...
            StateMachine<State, Trigger>.Transition
                transition = new StateMachine<State, Trigger>.Transition(State.A, State.B, Trigger.X),
                actualTransition = null;
            stateRepresentation.AddExitAction(t => actualTransition = t, MethodDescription.Create(null, "entryActionDescription"));
            stateRepresentation.Exit(transition);
            Assert.Equal(transition, actualTransition);
        }
        ...
        public void UponEntering_LeavingActionsNotExecuted()
        {
            ...
            StateMachine<State, Trigger>.Transition
                transition = new StateMachine<State, Trigger>.Transition(State.A, State.B, Trigger.X),
                actualTransition = null;
            stateRepresentation.AddExitAction(t => actualTransition = t, MethodDescription.Create(null, "exitActionDescription"));
            stateRepresentation.Enter(transition);
            Assert.Null(actualTransition);
        }
        ...
        public void WhenTransitioningFromSubToSuperstate_SubstateEntryActionsExecuted()
        {
            ...
            var executed = false;
            sub.AddEntryAction((t, a) => executed = true, MethodDescription.Create(null, "entryActionDescription"));
        ...
        public void WhenTransitioningFromSubToSuperstate_SubstateExitActionsExecuted()
        {
            ...
            var executed = false;
            sub.AddExitAction(t => executed = true, MethodDescription.Create(null, "exitActionDescription"));
        ...
        public void WhenTransitioningToSuperFromSubstate_SuperEntryActionsNotExecuted()
        {
            ...
            var executed = false;
            super.AddEntryAction((t, a) => executed = true, MethodDescription.Create(null, "entryActionDescription"));
            var transition = new StateMachine<State, Trigger>.Transition(super.UnderlyingState, sub.UnderlyingState, Trigger.X);
        ...
        public void WhenTransitioningFromSuperToSubstate_SuperExitActionsNotExecuted()
        {
            ...
            var executed = false;
            super.AddExitAction(t => executed = true, MethodDescription.Create(null, "exitActionDescription"));
            var transition = new StateMachine<State, Trigger>.Transition(super.UnderlyingState, sub.UnderlyingState, Trigger.X);
        ...
        public void EntryActionsExecuteInOrder()
        {
            ...
            rep.AddEntryAction((t, a) => actual.Add(0), MethodDescription.Create(null, "entryActionDescription"));
            rep.AddEntryAction((t, a) => actual.Add(1), MethodDescription.Create(null, "entryActionDescription"));
        ...
        public void ExitActionsExecuteInOrder()
        {
            ...
            var rep = CreateRepresentation(State.B);
            rep.AddExitAction(t => actual.Add(0), MethodDescription.Create(null, "entryActionDescription"));
            rep.AddExitAction(t => actual.Add(1), MethodDescription.Create(null, "entryActionDescription"));
        ...
        public void WhenEnteringSubstate_SuperstateEntryActionsExecuteBeforeSubstate()
        {
            ...
            super.AddEntryAction((t, a) => superOrder = order++, MethodDescription.Create(null, "entryActionDescription"));
            sub.AddEntryAction((t, a) => subOrder = order++, MethodDescription.Create(null, "entryActionDescription"));
            var transition = new StateMachine<State, Trigger>.Transition(State.C, sub.UnderlyingState, Trigger.X);
            sub.Enter(transition);
        ...
        public void WhenExitingSubstate_SubstateEntryActionsExecuteBeforeSuperstate()
        {
            ...
            int order = 0, subOrder = 0, superOrder = 0;
            super.AddExitAction(t => superOrder = order++, MethodDescription.Create(null, "entryActionDescription"));
            sub.AddExitAction(t => subOrder = order++, MethodDescription.Create(null, "entryActionDescription"));
            var transition = new StateMachine<State, Trigger>.Transition(sub.UnderlyingState, State.C, Trigger.X);
            sub.Exit(transition);
