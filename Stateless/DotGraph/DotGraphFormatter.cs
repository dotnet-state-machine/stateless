    ...
    public static class DotGraphFormatter
    {
        ...
        public static string Format(StateMachineInfo stateMachineInfo)
        {
            ...
            foreach (var binding in bindings)
            {
                ...
                {
                    string guardConditionsMethods = string.Join(", ", transition.GuardConditionsMethodDescriptions.Select(d => d.Description).ToArray());
        ...
        {
            string line = string.IsNullOrEmpty(guardDescription) || guardDescription == " " ?
